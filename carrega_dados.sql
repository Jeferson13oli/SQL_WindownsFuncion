...
/Users/inha_/Downloads/curso/SQL/Cap06/dados

LOAD DATA LOCAL INFILE '/Users/inha_/Downloads/curso/SQL/Cap06/dados/2012Q1-capitalbikeshare-tripdata.csv' INTO TABLE `cap06`.`TB_BIKES` CHARACTER SET UTF8
FIELDS TERMINATED BY ',' ENCLOSED BY '"' LINES TERMINATED BY '\r\n' IGNORE 1 LINES;
